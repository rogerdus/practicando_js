...
export default function PatientForm() {
  ...
  //const addPatient = usePatientStore((state) => state.addPatient);otra forma de llamarlo
...
(patient) => patient.id === activeId
  ...
  const registerPation = (data: DraftPatient) => {
    addPatient(data);
    reset();
  };
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      ...
      <form
        ...
        noValidate
        onSubmit={handleSubmit(registerPation)}
      >
        <div className="mb-5">
